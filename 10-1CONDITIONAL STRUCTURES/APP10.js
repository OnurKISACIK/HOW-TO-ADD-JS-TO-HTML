...
// if (finalPizza > 0 && finalPizza <= 40) {
//   console.log("Only" + finalPizza + "Pizza Left!!!");
// } else if (finalPizza < 0) {
...
// }
// //*--------------------------------------- */
let chosenBook = prompt("May I Take Your Order:");

const books = ["Harry Potter", "Lorf Of The Rings", "Stargate"];

for (const book of books) {
  console.log(books);
  if (books[i] === chosenBook) console.log("correct book chosen!");
}
